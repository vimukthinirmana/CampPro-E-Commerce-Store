    ...
    <div className="p-4">
      <form className='m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <select className='bg-slate-200 p-1 my-1' id='category' name='category' onChange={handleOnChange} value={data.category}>
          ...
          <option value={"sleepingGear"}>Sleeping Gear</option>
          <option value={"cookingEquipment"}>Cooking Equipment</option>
          <option value={"backpacks"}>Backpacks</option>
          <option value={"lighting"}>Lighting</option>
          <option value={"clothing"}>Clothing</option>
          <option value={"firstAidAndSafety"}>First Aid and Safety</option>
          <option value={"hydration"}>Hydration</option>
          <option value={"navigation"}>Navigation</option>
          <option value={"furnitureAndComfort"}>Furniture and Comfort</option>
        </select>
